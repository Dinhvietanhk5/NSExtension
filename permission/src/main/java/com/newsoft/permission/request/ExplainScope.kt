...
/**
 * Provide specific scopes for [com.newsoft.permission.callback.ExplainReasonCallback]
 * and [com.newsoft.permission.callback.ExplainReasonCallbackWithBeforeParam] to give it specific functions to call.
 * @author guolin
 * @since 2020/3/18
 */
