 ...
 */
package com.newsoft.permission.request
...
import com.newsoft.permission.callback.ExplainReasonCallbackWithBeforeParam
import com.newsoft.permission.callback.ForwardToSettingsCallback
import com.newsoft.permission.callback.RequestCallback
import com.newsoft.permission.dialog.DefaultDialog
import com.newsoft.permission.dialog.RationaleDialog
import com.newsoft.permission.dialog.RationaleDialogFragment
import java.util.*
...
class PermissionBuilder(
    ...
    /**
     * Do not display the explanation dialog again when the user denies permission
     */
    var explainPermissionWhenDenied = false
    ...
    /**
     * If the user does not grant permission, the dialog will not be displayed again
     */
    fun explainPermissionWhenDenied(): PermissionBuilder {
        explainPermissionWhenDenied = true
        return this
    }
