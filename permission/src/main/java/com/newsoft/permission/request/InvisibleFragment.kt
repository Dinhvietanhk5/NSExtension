...
import com.newsoft.permission.util.PermissionUtils
            ...
            if (checkForGC()) {
                ...
                if (allGranted) { // If all permissions are granted, finish current task directly.
                    ...
                    if ((pb.explainReasonCallback != null || pb.explainReasonCallbackWithBeforeParam != null) && showReasonList.isNotEmpty()) {
                        ...
                        if (pb.explainPermissionWhenDenied) {
...
//                } else if (pb.forwardToSettingsCallback != null && (pb.tempPermanentDeniedPermissions.isNotEmpty())) {

                    } else if (pb.forwardToSettingsCallback != null && (pb.tempPermanentDeniedPermissions.isNotEmpty() || forwardList.isNotEmpty())) {
                        shouldFinishTheTask =
